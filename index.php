    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/58.jpg" class="d-block w-100" style="height:50vh" alt="...">
            ...
            <div class="carousel-item">
                <img src="images/57.jpeg" class="d-block w-100" style="height:50vh" alt="...">
                <div class="carousel-caption" style="padding-bottom: 50px;">
                    <h1 class="textShadow">Welcome To Southern Pearl Hikkaduwa</h1>
        ...
        <div class="container">
            ...
            <div class="container pt-4 mt-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card" style="width: 18rem;">
                            <img src="images/Dine2.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
